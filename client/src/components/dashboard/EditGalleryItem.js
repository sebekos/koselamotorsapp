    ...
    return (
        <div className="form edit-gallery-item">
            ...
            <div className="edit-gallery-item-buttons">
                <div>
                    <Link to={"/editinfo/" + details._id} className="btn btn-dark">
                        Edit Info
                    </Link>
                </div>
                <div>
                ...
                <div>
                    <button onClick={() => onDelete(details._id)} className="btn btn-danger">
                        Delete Gallery
                    </button>
                </div>
            </div>
...
export default connect(null, { deleteGallery })(EditGalleryItem);
